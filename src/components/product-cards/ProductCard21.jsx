...
const ProductCard18 = ({ product }) => {
  ...
  const cartItem = state.cart.find((item) => item.id === product._id); // handle favourite
  ...
  const handleAddToCart = (product) => {
    const payload = {
      _id: product._id,
      name: product.title,
      imgUrl: urlForImage(product.previewImage).url(),
      price: product.price,
    ...
    <Card>
      ...
      {/* <ProductViewDialog
        ...
        product={{
          ...
          // imgGroup: [product.previewImage, product.previewImage],
        }}
      /> */}
