...
import CarouselCard8 from "components/carousel-cards/CarouselCard8";
...
const Section1 = () => {
    ...
    <>
      ...
      >
        ...
        <Paragraph
          ...
          mb={4}
        >
          Treat your team members, clients, and new employees to a meaningful
          gift that will grow for years to come. Add a personal touch with our
  ...
  return (
    <StyledBox pt={3}>
      {/* <Container> */}
      <CarouselCard8 content={carouselContent2} mode="light" />
      {/* </Carousel> */}
      {/* </Grid> */}
