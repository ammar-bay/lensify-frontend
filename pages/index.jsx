  ...
  return (
    <ShopLayout1 topbarBgColor={theme.palette.grey[900]}>
      ...
      <Box bgcolor="white">
        ...
        {/* FEATURED PRODUCTS */}
        <Section6 products={props.featuredProducts} />
...
export const getStaticProps = async () => {
  ...
  //
  const bestSellingProducts = await client.fetch(`
  ...
  const bestSellingCategories = await client.fetch(
    '*[_type == "category" && bestSeller == true]'
  );
